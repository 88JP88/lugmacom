...
//echo $correosJSON;
    ...
    $query= mysqli_query($conectar,"INSERT INTO mail_general (mail_id,sender_id,receiver_id,copy,name,content,category_id,type,parent_id) VALUES ('$primeros_ocho','$sender_id','$receiver_id','$correosJSON','$name','$content','inbox','inbox','$primeros_ocho')");
...
Flight::route('GET /getInboxMail/@id', function ($id) {
    ...
    $query= mysqli_query($conectar,"SELECT r.mail_id,r.sender_id,r.receiver_id,r.name,r.content,r.created_at,r.category_id,r.type,r.parent_id,r.copy FROM mail_general r where r.receiver_id = '$id' and r.category_id='inbox'  LIMIT 100");
...
Flight::route('GET /getSendMail/@id', function ($id) {
    ...
    $query= mysqli_query($conectar,"SELECT r.mail_id,r.sender_id,r.receiver_id,r.name,r.content,r.created_at,r.category_id,r.type,r.parent_id,r.copy FROM mail_general r where r.sender_id = '$id' ORDER BY r.created_at DESC  LIMIT 100");
